...
int main(int argc, char **argv)
{
    ...
    std::cout << "Number of page frames: " << numPageFrames << std::endl;
    ...
    ReplacementAlgorithm *opt = new OPT(numPageFrames, referenceString);
    ...
    std::cout << "OPT faults = " << opt->getPageFaultCount() << std::endl;
    return 0;
}